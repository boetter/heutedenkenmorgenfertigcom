export const services = [
    {
        ...
        plans: {
            title:
                "Der er brug for at løfte alle medarbejdere",
            list: [
                {
                    title: "Alle fortjener en personlig assistent",
                    content:
                        "AI kan ikke alt, men alle kan få glæde af at anvende AI-værktøjer som assistenter eller praktikanter. Her kan værktøjerne løse opgaver vi kender den korrekte løsning af og derved spare os tid.",
                },
                {
                    title: "Alle fortjener deres egen konsulent",
                    content:
                        "Når vi har trænet vores evne til at anvende AI, begynder vi at kunne give den opgaver vi ikke selv kender svaret på. Det kan hjælpe dig med at forstå de faglige problemer du støder på eller give dig et perspektiv du ikke havde overvejet.",
                },
                {
                    title: "Vi skal være stolte af at bruge AI",
                    content:
                        "I skolen får man besked på at brug af AI er snyd. På arbejdspladsen er man den eneste bruger og ingen forstår helt hvad der sker. Vi skal skabe en kultur hvor vi kan lære af de nye muligheder sammen, fremfor at skabe en skygge-organisation af hemmelige cyborgs.",
                },
                {
                    title: "Alle fortjener superkræfter",
                    content:
                        "Når vi bliver erfarne AI-brugere, begynder vi at kunne arbejde på helt nye måder. Det handler ikke så meget om effektivitet, men mere om højere kvalitet, arbejdsglæde, kreativitet og innovation.",
                },
            ],
        },
        description: {
            ...
            content:
                "Jacob Bøtter har arbejdet som foredragsholder, rådgiver og iværksætter indenfor AI og digital teknologi de sidste 20 år. Han har rådgivet hundredevis af virksomheder, organisationer og sågar statsministre indenfor området.",
        ...
        previewImage: "/images/image-8.jpg",
    },
    {
        id: "raadgivning",
        title: "RÅDGIVNING",
        ...
        kortforklaring:
            ...
            plans: {
                title:
                    "Som minimum bør alle danske virksomheder have styr på..",
                list: [
                    {
